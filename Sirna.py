...
import apoloRocket.freeEnergy as freeEnergy
import apoloRocket.TargetSequence as TargetSequence

class Sirna:
    def __init__(self, sequence:str)->None:
        self.sequence = sequence
        #bowtieData -> list of tuples=(hitTarget:TargetSequence, hitPos:int, hitStrand:str, hitMissmatches:int)
        self.bowtieData = []     
    ...
    def getEfficiency(self)->bool:
        return self.isEfficient == True

    def bowtieHits(self)->set:
        return set(self.bowtieData)

    def getOffTargets(self, mainTargets:list)->set:
        offTargets = set()
    ...
    def addBowtieAlignment(self, targetSeq:TargetSequence.TargetSequence, pos:int, strand:str, missmatches:int)->None:
        self.bowtieData.append((targetSeq, pos, strand, missmatches)) 

    def addRnaplfoldData(self, lunpData:list)->None:
